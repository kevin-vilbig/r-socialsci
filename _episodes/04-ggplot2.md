...
<img src="../fig/rmd-04-first-ggplot-1.png" title="plot of chunk first-ggplot" alt="plot of chunk first-ggplot" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-04-create-ggplot-object-1.png" title="plot of chunk create-ggplot-object" alt="plot of chunk create-ggplot-object" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-04-adding-transparency-1.png" title="plot of chunk adding-transparency" alt="plot of chunk adding-transparency" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-04-adding-jitter-1.png" title="plot of chunk adding-jitter" alt="plot of chunk adding-jitter" style="display: block; margin: auto;" />
...
~~~
ggplot(data = interviews_plotting, aes(x = no_membrs, y = number_items)) +
geom_jitter(aes(color = "blue"), alpha = 0.5)
~~~
{: .language-r}

<img src="../fig/rmd-04-adding-colors-1.png" title="plot of chunk adding-colors" alt="plot of chunk adding-colors" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-04-color-by-species-1.png" title="plot of chunk color-by-species" alt="plot of chunk color-by-species" style="display: block; margin: auto;" />
...
> > {: .language-r}
> > 
> > <img src="../fig/rmd-04-scatter-challenge-1.png" title="plot of chunk scatter-challenge" alt="plot of chunk scatter-challenge" style="display: block; margin: auto;" />
> {: .solution}
{: .challenge}
...
<img src="../fig/rmd-04-boxplot-1.png" title="plot of chunk boxplot" alt="plot of chunk boxplot" style="display: block; margin: auto;" />
...
ggplot(data = interviews_plotting, aes(x = respondent_wall_type, y = rooms)) +
    ...
    geom_jitter(alpha = 0.5, aes(color = "tomato"))
~~~
{: .language-r}

<img src="../fig/rmd-04-boxplot-with-points-1.png" title="plot of chunk boxplot-with-points" alt="plot of chunk boxplot-with-points" style="display: block; margin: auto;" />
